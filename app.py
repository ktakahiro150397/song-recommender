...
pages = [
    ...
    st.Page("pages/2_📤_楽曲ファイルアップロード.py", title="楽曲ファイルアップロード", icon="📤"),
    st.Page("pages/3_🗄️_DBメンテナンス.py", title="DBメンテナンス", icon="🗄️"),
    st.Page("pages/4_🗄️_DBメンテナンス_楽曲登録.py", title="DBメンテナンス 楽曲登録", icon="🗄️"),
    st.Page("pages/5_📺_YouTubeチャンネル登録.py", title="YouTubeチャンネル登録", icon="📺"),
